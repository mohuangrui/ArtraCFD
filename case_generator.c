...
static int CaseGeometryFileGenerator(void)
{
    ...
    fprintf(filePointer, "# O, r, Fp, Fv, rho, T, cf, area, volume, matID\n");
    fprintf(filePointer, "# V, W, a, g, alpha, to\n");
    ...
    fprintf(filePointer, "# (ax, ay, az): input translational acceleration\n");
    fprintf(filePointer, "# (gx, gy, gz): gravitational acceleration\n");
    fprintf(filePointer, "# (alphax, alphay, alphaz): input rotational acceleration\n");
    fprintf(filePointer, "# (Fpx, Fpy, Fpz): pressure force\n");
    fprintf(filePointer, "# (Fvx, Fvy, Fvz): viscous force\n");
    fprintf(filePointer, "# to: time to end input a and alpha; <= 0 if never end\n");
    ...
    fprintf(filePointer, "# stationary object: V = 0; W = 0; a = 0; g = 0; alpha = 0; rho > 1.0e36;\n");
    fprintf(filePointer, "#\n");
    fprintf(filePointer, "#------------------------------------------------------------------------------\n");
    fprintf(filePointer, "#\n");
    ...
    fprintf(filePointer, "0, 0, 0, 0.5, 0, 0, 0, 0, 0, 0, 1.0e37, -1, 1, 0, 0, 0\n");
