...
static int CaseSettingFileGenerator(void)
{
    ...
    fprintf(filePointer, "-1                 # maximum steps to force cease (integer; -1: disable)\n");
    ...
    fprintf(filePointer, "0                  # fluid solid interaction (integer; 0: Off; 1: On)\n");
    ...
    fprintf(filePointer, "1                  # modify coefficient of dynamic viscosity (0: inviscid)\n");
